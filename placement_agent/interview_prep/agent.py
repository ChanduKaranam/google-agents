...
interview_prep_agent = Agent(
    ...
    instruction=(
        ...
        "7. init_progress(user_id, role, difficulty='easy')\n"
        "   -> Initializes a progress tracking session for the user.\n"
        "   -> Call this after detecting the role. Use 'default_user' as user_id\n"
        "      unless the user provides their name.\n\n"
        "8. mark_topic_complete(user_id, topic)\n"
        ...
        "3. Call init_progress('default_user', role) to start tracking.\n"
        ...
        "   log_question_attempt(user_id, correct=True/False).\n"
        ...
        "5. Call log_mock_interview(user_id).\n"
        ...
        "1. Call get_progress_summary(user_id).\n"
        ...
        "5. Call suggest_next_step(user_id) and highlight it as the priority action.\n\n"
